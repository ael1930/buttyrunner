...
<html lang="en">
  ...
  <body>
	  ...
	  <div class="jumbotron">
		  <h1>About</h1>
		  <p class="lead">What's ButtyRunner all about?</p>
	  </div>
	  <h2>What is it?</h2>
	  ...
	  <h2>Is it free?</h2>
	  <p>At the moment yes. But like all things, it costs a little to run. If you want to make a donation towards these runniung costs, then I'll be putting PayPal details on the site soon. In the future however, there will be advertising and some revenue generating micro-payments introduced.</p>  
	  </div>
